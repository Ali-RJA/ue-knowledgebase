// Auto-generated from cpp-common-ue-pieces.html
// Contains 113 lego pieces

import type { LegoPiece } from '../types/content';

export const allLegoPieces: LegoPiece[] = [
  {
    id: "lego-001",
    slug: "uclass-generatedbody",
    title: "UCLASS() & GENERATED_BODY()",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Unreal Header Tool (UHT)","Class Default Object (CDO)","Reflection Metadata"],
    summary: "The UCLASS macro is the gateway to Unreal Engine's reflection system. It tells the Unreal Header Tool (UHT) to parse this class and generate the necessary boilerplate code in the .generated.h file.",
...
public:
    ...
    explanation: `<h3>The Reflection Foundation</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Garbage Collection","Detail Panels","Metadata Specifiers"],
    summary: "UPROPERTY is the most used macro in Unreal. It serves two critical purposes: exposing variables to the Editor/Blueprints and notifying the Garbage Collector that an object is in use.",
...
TObjectPtr<UStaticMeshComponent> WeaponMesh;`,
    explanation: `<h3>Connecting C++ to the Editor</h3>
  ...
  {
    id: "lego-003",
    slug: "ufunctionblueprintcallable",
    title: "UFUNCTION(BlueprintCallable)",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Execution Pins","Pure vs Impure","Console Commands"],
    summary: "UFUNCTION allows your C++ methods to be called from the Blueprint Graph, Console, or over the Network.",
...
void Debug_KillAllEnemies();`,
    explanation: `<h3>Exposing Logic to Blueprints</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","C++/BP Hybrid","_Implementation Suffix","Virtual Functions"],
    summary: "BlueprintNativeEvent is the most powerful way to bridge C++ and Blueprints. It provides a default C++ implementation while allowing designers to completely override or extend it in Blueprints.",
...
void AMyActor::OnInteract_Implementation(AActor* Interactor)
{
    ...
    explanation: `<h3>The Hybrid Event Pattern</h3>
  ...
  {
    id: "lego-005",
    slug: "blueprintimplementableevent",
    title: "BlueprintImplementableEvent",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Event Driven Design","Decoupling","Designer Hooks"],
    summary: "BlueprintImplementableEvent is used when C++ handles the \"When\" but Blueprints handle the \"What\". C++ provides no default logic; if the Blueprint doesn't implement the event, nothing happens.",
    codeSnippet: `// --- Header (.h) ---
...
void AMyActor::ReactToHit()
{
    ...
    explanation: `<h3>C++ Triggered, Designer Defined</h3>
                    ...
                    <p>This is the ultimate tool for <strong>Decoupling</strong>. Your C++ "Combat System" doesn't need to know about "Particle Systems" or "Sound Waves" — it just broadcasts the event and lets the designers handle the rest.</p>`,
    diagram: `graph LR
  ...
  {
    id: "lego-006",
    slug: "uenum-enum-definition",
    title: "UENUM() Enum Definition",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","State Machines","Metadata Names","Blueprint Type Compatibility"],
    summary: "Enums in Unreal Engine must be enum class and use uint8 as the underlying type to be compatible with the reflection system.",
    codeSnippet: `UENUM(BlueprintType)
...
ECombatState CurrentState = ECombatState::Idle;`,
    explanation: `<h3>Type-Safe State Management</h3>
  ...
  {
    id: "lego-007",
    slug: "ustruct-data-container",
    title: "USTRUCT() Data Container",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Data Bundling","Break/Make Nodes","Value Types"],
    summary: "USTRUCT allows you to group related variables into a single package. This makes your code cleaner and allows Blueprints to treat the group as a single variable type.",
    codeSnippet: `USTRUCT(BlueprintType)
struct FWeaponStats
{
    GENERATED_BODY()
    ...
    explanation: `<h3>Bundling Related Data</h3>
  ...
  {
    id: "lego-008",
    slug: "meta-allowprivateaccess",
    title: "Meta: AllowPrivateAccess",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Encapsulation","C++/BP Security","Least Privilege"],
    summary: "Normally, private variables are hidden from the reflection system. AllowPrivateAccess bypasses this, allowing Blueprints to see and edit variables while keeping them protected from other C++ classes.",
    codeSnippet: `private:
    ...
    explanation: `<h3>Encapsulation meets Flexibility</h3>
  ...
  {
    id: "lego-009",
    slug: "meta-bindwidget-umg",
    title: "Meta: BindWidget (UMG)",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","UMG Integration","Auto-Wiring","UI/Logic Separation"],
    summary: "BindWidget is the cleanest way to connect C++ logic to UMG UI elements. When the widget is created, the engine automatically searches for a widget with the same name and assigns it to your pointer.",
    codeSnippet: `// --- MyUserWidget.h ---
UCLASS()
...
protected:
    ...
    explanation: `<h3>Automated UI Linking</h3>
  ...
  {
    id: "lego-010",
    slug: "meta-exposeonspawn",
    title: "Meta: ExposeOnSpawn",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Spawning Lifecycle","Blueprint Nodes","Initialization Patterns"],
    summary: "Setting ExposeOnSpawn adds the variable as an input pin on the \"Spawn Actor from Class\" node in Blueprints. This allows you to set the value before the actor's BeginPlay runs.",
    codeSnippet: `UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (ExposeOnSpawn = "true"))
int32 TeamID = 0;

UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (ExposeOnSpawn = "true"))
FVector InitialVelocity;`,
    explanation: `<h3>Initialization at Birth</h3>
  ...
  },
  {
    ...
    title: "BeginPlay()",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Initialization Order","World Context","Virtual Overrides"],
    summary: "BeginPlay is the most common entry point for gameplay logic. It fires once when the actor is spawned into a valid world or when the level starts.",
    codeSnippet: `// .h
...
void AMyActor::BeginPlay()
{
    ...
    explanation: `<h3>The Start of Gameplay</h3>
  ...
  {
    id: "lego-012",
    slug: "tickfloat-deltatime",
    title: "Tick(float DeltaTime)",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Frame-rate Independence","DeltaTime Calculation","Game Loop"],
    summary: "The Tick function runs every frame. The DeltaTime parameter is the amount of time (in seconds) that has passed since the last frame.",
    codeSnippet: `// .h
...
void AMyActor::Tick(float DeltaTime)
{
    ...
    explanation: `<h3>Frame-by-Frame Updates</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Object Instantiation","Memory Allocation","Spawn Collision Handling"],
    summary: "SpawnActor is the standard way to instantiate new physical objects into the world during gameplay, such as projectiles, enemies, or dropped items.",
    codeSnippet: `// Define spawn parameters
...
if (NewProj) {
    ...
    explanation: `<h3>Creating Actors at Runtime</h3>
  ...
  {
    id: "lego-014",
    slug: "ftimerhandle-settimer",
    title: "FTimerHandle & SetTimer",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Asynchronous Execution","Performance Optimization","Handle-based Logic"],
    summary: "Timers are the professional alternative to Tick. They allow you to execute logic at specific intervals or after a delay without running code every single frame.",
    codeSnippet: `FTimerHandle ReticleTimerHandle;
...
GetWorldTimerManager().ClearTimer(ReticleTimerHandle);`,
    explanation: `<h3>The High-Performance Delay</h3>
  ...
  {
    id: "lego-015",
    slug: "endplayconst-eendplayreason",
    title: "EndPlay(const EEndPlayReason)",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Cleanup Phase","Memory Safety","Destruction Reasons"],
    summary: "EndPlay is the final lifecycle event for an actor. It is called when the actor is being removed from the world for any reason (destruction, level transition, or quitting the game).",
    codeSnippet: `virtual void EndPlay(const EEndPlayReason::Type EndPlayReason) override;
...
void AMyActor::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
    ...
    explanation: `<h3>The Graceful Exit</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","UObject vs AActor","Ownership (Outer)","Memory Management"],
    summary: "Actors (physical objects) use SpawnActor, but classes derived from UObject (pure data/logic) use NewObject.",
    codeSnippet: `// Creating a data container during gameplay
...
if (NewInv) {
    ...
    explanation: `<h3>Instantiating UObjects</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Garbage Collection","Lifecycle Termination","Object Validity"],
    summary: "Destroy() tells the engine that this actor is no longer needed. It doesn't delete the object from memory instantly; instead, it marks it as \"Pending Kill\" and removes it from the world at the end of t",
    codeSnippet: `void AMyActor::TakeFatalDamage()
{
    ...
    explanation: `<h3>Removing Actors</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","CDO (Class Default Object)","Component Hierarchy","Memory Pre-allocation"],
    summary: "CreateDefaultSubobject is the only way to create components in an actor's constructor. Components created this way are part of the Class Default Object (CDO), meaning they will exist automatically on ",
    codeSnippet: `// Inside the Actor Constructor (.cpp)
AMyActor::AMyActor()
{
    ...
    explanation: `<h3>Building the Actor's Body</h3>
  ...
  {
    id: "lego-022",
    slug: "findcomponentbyclass",
    title: "FindComponentByClass",
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","Decoupled Logic","Component Searching","Type Safety"],
    summary: "Instead of checking \"Is this actor an Enemy?\", the best practice in UE5 is to check \"Does this actor have a Health Component?\". This is called Component-Based Architecture.",
    codeSnippet: `// Find the health component on another actor
...
else
{
    ...
    explanation: `<h3>Modular Communication</h3>
  ...
  {
    id: "lego-023",
    slug: "getcomponentbytag",
    title: "GetComponentByTag",
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","Designer/Coder Workflow","String-based Identification","Collection Filtering"],
    summary: "Tags are strings that designers can add to components in the Editor. They are incredibly useful for identifying specific parts of a complex actor without needing hard-coded pointers.",
    codeSnippet: `// Get a component by its designer-assigned tag
...
TArray<UActorComponent*> FirePoints = GetComponentsByTag(UPrimitiveComponent::StaticClass(), TEXT("Muzzle"));`,
    explanation: `<h3>Identifying Specific Parts</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","Transform Hierarchy","Parent/Child Relationships","Socket-based Attachment"],
    summary: "SetupAttachment builds the transform hierarchy in the constructor. If the parent component moves, rotates, or scales, the child will follow.",
    codeSnippet: `// Inside Constructor
...
WeaponComp->SetupAttachment(RootComponent, TEXT("Hand_R_Socket"));`,
    explanation: `<h3>Defining the Tree</h3>
  ...
  {
    id: "lego-025",
    slug: "getcharactermovement",
    title: "GetCharacterMovement()",
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","Locomotion Systems","Client-Side Prediction","Physics Constraints"],
    summary: "The UCharacterMovementComponent is one of the most complex and powerful systems in Unreal. It handles walking, falling, swimming, flying, and even networking (replication/prediction) automatically.",
    codeSnippet: `// Tweak movement at runtime
...
if (MoveComp)
{
    ...
    explanation: `<h3>The Movement Powerhouse</h3>
  ...
  {
    id: "lego-031",
    slug: "fvector-math-basics",
    title: "FVector Math Basics",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Euclidean Space","Vector Normalization","Coordinate Systems (X=Forward, Y=Right, Z=Up)"],
    summary: "Unreal uses FVector for positions, directions, and scales. Understanding vector math is essential for almost every gameplay feature.",
    codeSnippet: `FVector Forward = GetActorForwardVector();
...
FVector Dir = (LocB - LocA).GetSafeNormal();`,
    explanation: `<h3>Navigating 3D Space</h3>
  ...
  {
    id: "lego-032",
    slug: "fmathfinterpto-smooth-move",
    title: "FMath::FInterpTo (Smooth Move)",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Smoothing Algorithms","User Experience (Juice)","Frame-rate Independent Motion"],
    summary: "Interpolation (Interp) is the secret to making things feel smooth. Instead of a value snapping instantly from 0 to 100, Interp moves it there gradually over several frames.",
    codeSnippet: `// Inside Tick
...
CurrentDisplayHealth = FMath::FInterpTo(
    ...
    explanation: `<h3>Adding "Juice" with Interpolation</h3>
  ...
  {
    id: "lego-033",
    slug: "frotator-pitchyawroll",
    title: "FRotator (Pitch/Yaw/Roll)",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Euler Angles","Local vs World Rotation","Quaternions (FQuat)"],
    summary: "Unreal Engine uses Euler Angles (Degrees) for rotations. The FRotator struct contains three values: Pitch, Yaw, and Roll.",
    codeSnippet: `// Rotate 90 degrees to face East (Yaw)
...
FRotator Combined = FRotator(10, 0, 0) + FRotator(0, 45, 0);`,
    explanation: `<h3>Orientation in 3D</h3>
  ...
  {
    id: "lego-034",
    slug: "fvectordotproduct",
    title: "FVector::DotProduct",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Trigonometry","Field of View","Backstab Logic"],
    summary: "The Dot Product is a mathematical operation that takes two directions and returns a single number between -1 and 1. It tells you how much two vectors \"point in the same direction\".",
    codeSnippet: `FVector MyForward = GetActorForwardVector();
...
{ 
    ...
    explanation: `<h3>Directional Alignment</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Boundary Safety","Data Sanitization","Range Validation"],
    summary: "Clamp is a simple but vital function that forces a value to stay within a specific range. If the value is higher than the max, it returns the max. If it's lower than the min, it returns the min.",
    codeSnippet: `// Ensure health never goes below 0 or above 100
Health = FMath::Clamp(Health + HealingAmount, 0.f, 100.f);

// Clamp for integers
int32 Level = FMath::Clamp(CurrentLevel, 1, 50);`,
    explanation: `<h3>Bounding Values</h3>
  ...
  {
    id: "lego-036",
    slug: "findlookatrotation",
    title: "FindLookAtRotation",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Targeting","NPC Orientation","Coordinate Transformation"],
    summary: "This function calculates the rotation required to point an object's X-axis (Forward) directly at a target position.",
    codeSnippet: `// Get the rotation needed to face an enemy
...
SetActorRotation(LookAtRot);`,
    explanation: `<h3>Aiming and Facing</h3>
  ...
  {
    id: "lego-037",
    slug: "ftransform-posrotscale",
    title: "FTransform (Pos/Rot/Scale)",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Matrix Math","Local vs World Space","Spatial State"],
    summary: "While an actor's position and rotation are often used separately, they are stored together in an FTransform. This struct holds the Location, Rotation (as a Quaternion), and Scale.",
    codeSnippet: `// Capture current transform
...
FVector WorldPoint = MyTM.TransformPosition(FVector(100, 0, 0));`,
    explanation: `<h3>The Complete 3D State</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Raycasting","Collision Filtering","Impact Analysis"],
    summary: "Line Tracing (also called Raycasting) is the primary way to \"see\" things in the physics world. You shoot an invisible line between two points and the engine tells you the first thing it hits.",
    codeSnippet: `FHitResult Hit;
...
if (bHit)
{
    ...
    explanation: `<h3>The "Laser Beam" Scan</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Trigger Volumes","Dynamic Delegates","Event Filtering"],
    summary: "Overlaps are used for \"Trigger Zones\" where you want to detect when an object enters an area without physically blocking it (like a pressure plate or a poison cloud).",
    codeSnippet: `// .h
UFUNCTION()
...
void AMyActor::OnOverlapBegin(...)
{
    ...
    explanation: `<h3>Trigger Zones and Overlaps</h3>
  ...
  {
    id: "lego-043",
    slug: "sweepsinglebyprofile",
    title: "SweepSingleByProfile",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Volume Casting","Collision Shapes","Profile-based Filtering"],
    summary: "A Line Trace is an infinitely thin line. A Sweep is a 3D shape (Sphere, Box, or Capsule) being pushed through space. This is much more accurate for projectiles or melee weapons.",
    codeSnippet: `FHitResult Hit;
FVector Start = GetActorLocation();
...
bool bHit = GetWorld()->SweepSingleByProfile(
    ...
    explanation: `<h3>Traces with "Thickness"</h3>
  ...
  {
    id: "lego-044",
    slug: "overlapmultibyobjecttype",
    title: "OverlapMultiByObjectType",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","AoE (Area of Effect)","Physics Object Types","Spatial Queries"],
    summary: "When you need to find all objects in an area (like an explosion or a radar ping), you use a \"Multi\" overlap function.",
...
for (const FOverlapResult& Result : Overlaps)
{
    ...
    explanation: `<h3>Area of Effect (AoE) Scans</h3>
  ...
  {
    id: "lego-045",
    slug: "addforce-addimpulse",
    title: "AddForce / AddImpulse",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Newtonian Physics","Acceleration","Velocity Change"],
    summary: "To move objects using Unreal's physics engine (PhysX/Chaos), you apply Forces or Impulses. The object must have \"Simulate Physics\" enabled.",
    codeSnippet: `// 1. A continuous push (e.g., wind or a rocket)
...
// Use this if you want the same kick regardless of weight.`,
    explanation: `<h3>Applying Physical Power</h3>
  ...
  {
    id: "lego-046",
    slug: "collision-profiles",
    title: "Collision Profiles",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Collision Matrix","Interaction Presets","Physics Optimization"],
    summary: "Collision Profiles are \"Presets\" that define how an object interacts with every other object in the game. Instead of setting 20 different checkboxes manually, you just select a profile like \"Pawn\" or ",
    codeSnippet: `// Change the entire collision behavior at once
Mesh->SetCollisionProfileName(TEXT("OverlapAll"));

// Or tweak specific responses
Mesh->SetCollisionResponseToChannel(ECC_Pawn, ECR_Block);
Mesh->SetCollisionResponseToAllChannels(ECR_Ignore);`,
    explanation: `<h3>Managing Physics Rules</h3>
  ...
  {
    id: "lego-051",
    slug: "dynamic-multicast-delegate",
    title: "Dynamic Multicast Delegate",
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Observer Pattern","Decoupling","Event-Driven Programming"],
    summary: "Delegates are Unreal's implementation of the Observer Pattern. A class can \"Broadcast\" an event, and any number of other classes can \"Listen\" to it without being tightly coupled.",
    codeSnippet: `// .h
...
public:
    ...
    explanation: `<h3>The Radio Broadcast Pattern</h3>
  ...
  {
    id: "lego-052",
    slug: "adddynamic-binding",
    title: "AddDynamic (Binding)",
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Subscription Model","Function Pointers","Reflection-based Binding"],
    summary: "AddDynamic is the helper macro used to bind a C++ function to a Dynamic Multicast Delegate. It allows your class to \"subscribe\" to notifications from another object.",
    codeSnippet: `// Inside BeginPlay
...
void HandleBossDeath(AActor* DeadBoss)
{
    ...
    explanation: `<h3>Listening to Events</h3>
  ...
  {
    id: "lego-053",
    slug: "tfunction-lambdas",
    title: "TFunction (Lambdas)",
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Functional Programming","Scope Capturing","Inline Logic"],
    summary: "Sometimes you need a quick bit of logic that doesn't deserve its own named function in the header file. This is where Lambdas and TFunction come in.",
    codeSnippet: `// Define a function on the fly!
...
SomeAsyncObject->DoWork(MySuccessCallback);`,
    explanation: `<h3>Anonymous Functions</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Method Overriding","Class Hierarchy","Boilerplate Safety"],
    summary: "In C++, Super is a shorthand for \"the class I inherited from\". Calling Super::FunctionName() ensures that you don't accidentally \"overwrite\" critical engine logic.",
    codeSnippet: `void AMyPlayer::BeginPlay()
{
...
void AMyPlayer::Jump()
{
    ...
    explanation: `<h3>Inheriting Engine Power</h3>
  ...
  {
    id: "lego-061",
    slug: "tsoftobjectptr-async-loading",
    title: "TSoftObjectPtr (Async Loading)",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Lazy Loading","Memory Management","Asset Registry"],
    summary: "Normally, a UStaticMesh* pointer is a \"Hard Reference\". This means if you load an actor that uses that mesh, the mesh is loaded into memory instantly. TSoftObjectPtr is a \"Soft Reference\" — it only st",
    codeSnippet: `// .h
...
void AMyActor::LoadMesh()
{
    ...
    explanation: `<h3>Memory-Safe References</h3>
                    <p>Normally, a <code>UStaticMesh*</code> pointer is a "Hard Reference". This means if you load an actor that uses that mesh, the mesh is loaded into memory instantly. <code>TSoftObjectPtr</code> is a "Soft Reference" — it only stores the string path to the asset.</p>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Dynamic Arrays","Cache Locality","Index-based Access"],
    summary: "TArray is the most used container in Unreal Engine. It's a dynamically resizing array that stores items in a continuous block of memory, making it extremely fast to iterate through.",
    codeSnippet: `TArray<AActor*> NearbyEnemies;
...
for (AActor* Enemy : NearbyEnemies) { ... }`,
    explanation: `<h3>The Standard List</h3>
  ...
  {
    id: "lego-063",
    slug: "tmap-key-value-pairs",
    title: "TMap (Key-Value Pairs)",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Hash Tables","O(1) Search","Associative Containers"],
    summary: "A TMap (Dictionary) stores data in Key-Value pairs. It is optimized for finding a specific \"Value\" by looking up a unique \"Key\".",
    codeSnippet: `TMap<FString, int32> HighScores;
...
HighScores.Remove(TEXT("John"));`,
    explanation: `<h3>Fast Lookups</h3>
  ...
  {
    id: "lego-064",
    slug: "udatatablefindrow",
    title: "UDataTable::FindRow",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Spreadsheet Integration","FTableRowBase","Content Scaling"],
    summary: "DataTables allow you to move your game balance (speeds, damage, health) out of the code and into a spreadsheet-like Editor tool. This is essential for large projects where designers need to tweak valu",
    codeSnippet: `// .h
...
if (Data)
{
    ...
    explanation: `<h3>Data-Driven Design</h3>
  ...
  {
    id: "lego-065",
    slug: "uprimarydataasset",
    title: "UPrimaryDataAsset",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Custom Assets","Asset Manager","Modular Data"],
    summary: "While DataTables are great for lists of similar things, UPrimaryDataAsset is better for unique, complex objects like a \"Fireball Spell\" or a \"Quest Definition\".",
    codeSnippet: `// .h
...
public:
    ...
    explanation: `<h3>Custom Asset Types</h3>
  ...
  {
    id: "lego-066",
    slug: "fstring-vs-fname-vs-ftext",
    title: "FString vs FName vs FText",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Localization","String Hashing","Memory Allocation"],
    summary: "Unreal Engine uses three different types for text data, each optimized for a specific job. Choosing the wrong one can lead to performance issues or UI bugs.",
    codeSnippet: `// 1. FString - The Workhorse
FString MyStr = "Hello";
MyStr += " World";
MyStr.ToLowerInline();
...
FText DisplayName = NSLOCTEXT("UI", "HealthLabel", "Health");`,
    explanation: `<h3>The Trinity of Strings</h3>
  ...
  {
    id: "lego-071",
    slug: "getgameinstance-subsystems",
    title: "GetGameInstance Subsystems",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Modular Architecture","Global Singletons","Engine Lifecycles"],
    summary: "In older versions of Unreal, everyone put their global logic in the GameInstance or GameMode, leading to giant, messy files. Subsystems solve this by providing modular, self-contained global objects.",
    codeSnippet: `// Fetching a subsystem from any actor
...
if (MySub)
{
    ...
    explanation: `<h3>Modern Global Logic</h3>
  ...
  {
    id: "lego-072",
    slug: "hasauthority-networking",
    title: "HasAuthority() (Networking)",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Client/Server Model","Authoritative Logic","Anti-Cheat"],
    summary: "HasAuthority() tells you if the current code is running on the \"Source of Truth\" (the Server) or on a \"Remote Proxy\" (the Player's Computer).",
    codeSnippet: `void AMyWeapon::Fire()
{
    if (HasAuthority())
    {
    ...
    explanation: `<h3>Multiplayer Security</h3>
  ...
  {
    id: "lego-073",
    slug: "islocallycontrolled",
    title: "IsLocallyControlled()",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Possession","Local User Context","Multiplayer UI"],
    summary: "In a multiplayer game, you might see 4 characters on your screen. But only one of them is \"You\". IsLocallyControlled() helps you distinguish between your character and the other players.",
    codeSnippet: `void AMyCharacter::BeginPlay()
{
    Super::BeginPlay();
    ...
    explanation: `<h3>Local vs Proxy</h3>
  ...
  {
    id: "lego-074",
    slug: "aplayercontroller-access",
    title: "APlayerController Access",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Human-Computer Interface","Actor Possession","Persistence"],
    summary: "The PlayerController is the interface between the human player and the game. While the Pawn is the physical body that can be killed or swapped, the PlayerController persists and represents the player'",
    codeSnippet: `// Get the controller from an actor
...
if (PC)
{
    ...
    explanation: `<h3>The Player's Will</h3>
  ...
  {
    id: "lego-075",
    slug: "enhanced-input-bindaction",
    title: "Enhanced Input (BindAction)",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Input Actions","Mapping Contexts","Input Modifiers"],
    summary: "Enhanced Input is the UE5 standard for handling player controls. It is much more flexible than the old \"Action Mappings\" because it allows for runtime remapping, complex triggers (hold, tap, chord), a",
    codeSnippet: `// .h
...
void AMyChar::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    explanation: `<h3>Next-Gen Input</h3>
  ...
  {
    id: "lego-081",
    slug: "uelog-debugging",
    title: "UE_LOG (Debugging)",
    type: 'lego-piece',
    pieceType: "UI & Debug",
    tags: ["UI","Log Categories","Printf Formatting","Verbosity Levels"],
    summary: "UE_LOG is the primary tool for debugging C++ in Unreal. It prints messages to the Output Log window, allowing you to track variables and logic flow without stopping the game.",
    codeSnippet: `// 1. Simple text log
...
UE_LOG(LogTemp, Error, TEXT("CRITICAL: Component %s is null!"), *GetName());`,
    explanation: `<h3>Talking to the Console</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "UI & Debug",
    tags: ["UI","3D Visualization","Physics Debugging","Development Tools"],
    summary: "Debugging physics or math in your head is hard. DrawDebugLine (and its siblings like DrawDebugSphere and DrawDebugBox) allows you to draw shapes directly in the 3D game world.",
    codeSnippet: `FVector Start = GetActorLocation();
FVector End = Start + (GetActorForwardVector() * 500.f);
...
DrawDebugLine(
    ...
    explanation: `<h3>Visualizing the Invisible</h3>
  ...
  {
    id: "lego-083",
    slug: "nativeconstruct-ui-start",
    title: "NativeConstruct (UI Start)",
    type: 'lego-piece',
    pieceType: "UI & Debug",
    tags: ["UI","UMG Lifecycle","UI Event Binding","Widget Initialization"],
    summary: "NativeConstruct is the C++ equivalent of the \"Construct\" event in Widget Blueprints. It is called when the widget is created and ready to be used.",
    codeSnippet: `// .h
...
void UMyWidget::NativeConstruct()
{
    ...
    explanation: `<h3>The BeginPlay of UI</h3>
  ...
  {
    id: "lego-091",
    slug: "castt-safe-type-casting",
    title: "Cast<T> (Safe Type Casting)",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Runtime Type Information (RTTI)","Inheritance","Pointer Safety"],
    summary: "Unreal's Cast&lt;T&gt; is a specialized version of C++ casting that uses the reflection system to safely convert pointers between classes.",
    codeSnippet: `// Safely check if an actor is a character
...
else
{
    ...
    explanation: `<h3>Safe Inheritance Checks</h3>
  ...
  {
    id: "lego-092",
    slug: "tobjectptr-smart-pointer",
    title: "TObjectPtr (Smart Pointer)",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Pointer Modernization","Editor Debugging","Zero-Cost Abstractions"],
    summary: "In Unreal Engine 5, TObjectPtr replaced raw pointers (e.g., UStaticMesh*) for class properties. It is a \"smart\" pointer designed specifically for the reflection system.",
    codeSnippet: `// UE5 Header Standard (.h)
...
if (MeshPtr)
{
    ...
    explanation: `<h3>The New UE5 Standard</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Circular References","Memory Management","Validity Checking"],
    summary: "A \"Hard Pointer\" (like TObjectPtr or a raw pointer) prevents the Garbage Collector from deleting an object. A Weak Pointer does NOT.",
    codeSnippet: `// Store a reference to an enemy without 'owning' it
...
void AMyActor::AttackTarget() {
    ...
    explanation: `<h3>Preventing Memory Leaks</h3>
  ...
  {
    id: "lego-094",
    slug: "uinterface-setup",
    title: "UINTERFACE Setup",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Decoupling","Polymorphism","Cross-Class Communication"],
    summary: "Interfaces allow completely different classes (like a \"Door\" and an \"NPC\") to share common functionality (like being \"Interactable\") without inheriting from the same parent.",
    codeSnippet: `// .h - The Blueprint-visible part
...
if (OtherActor->GetClass()->ImplementsInterface(UInteractable::StaticClass())) {
    ...
    explanation: `<h3>The Gameplay Contract</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Read-only access","BlueprintPure logic","Compiler Optimization"],
    summary: "In C++, adding const to a function tells the compiler (and other programmers) that this function is \"Read-Only\" and won't modify the state of the object.",
    codeSnippet: `// This function PROMISES not to change any variables
...
{ 
    ...
    explanation: `<h3>Code Safety and Optimization</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Inheritance","Function Shadowing","Virtual Method Tables (VMT)"],
    summary: "These two keywords are the foundation of inheritance. They allow you to define a general behavior in a \"Parent\" class and then specialize it in a \"Child\" class.",
    codeSnippet: `// --- BaseClass.h ---
virtual void Die();
...
void AChildClass::Die() 
{
    ...
    explanation: `<h3>Polymorphism in Unreal</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Assertions","Defensive Programming","Error Propagation"],
    summary: "Unreal provides several \"Assert\" macros to help you catch bugs early in development. They act as internal documentation for what your code expects.",
    codeSnippet: `// 1. check: Use for things that MUST be true
...
if (ensure(CurrentLevel > 0)) {
    ...
    explanation: `<h3>Professional Error Handling</h3>
  ...
  {
    id: "lego-098",
    slug: "isa-type-checking",
    title: "IsA() Type Checking",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Class Hierarchy","Type Identification","Reflection Performance"],
    summary: "IsA() is a high-performance function used to check if an object belongs to a specific class or inherits from it. It's the faster, \"lighter\" version of Cast&lt;T&gt;.",
    codeSnippet: `// A fast check without needing a variable
if (OtherActor->IsA(ACharacter::StaticClass()))
{
    // We know it's a character, even without casting!
    UE_LOG(LogTemp, Log, TEXT("Watch out, a character!"));
}`,
    explanation: `<h3>Quick Class Validation</h3>
  ...
  {
    id: "lego-110",
    slug: "getworld-entry-point",
    title: "GetWorld() Entry Point",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","World Context","Singleton Access","Execution Environment"],
    summary: "GetWorld() is the gateway to almost every high-level engine feature. If an Actor doesn't have a valid world, it basically doesn't exist in the game simulation.",
    codeSnippet: `// Safely accessing the world
...
if (World)
{
    ...
    explanation: `<h3>The World Context</h3>
  ...
  {
    id: "lego-111",
    slug: "staticloadobject-sync",
    title: "StaticLoadObject (Sync)",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Synchronous I/O","Asset Referencing","Manual Memory Loading"],
    summary: "While TSoftObjectPtr is the preferred way to load things, StaticLoadObject is the \"Hammer\" that forces an asset to load from the disk right now.",
    codeSnippet: `// Force-load a texture from the hard drive
...
if (MyIcon) {
    ...
    explanation: `<h3>Forced Loading</h3>
  ...
  {
    id: "lego-112",
    slug: "fmathmaprangeclamped",
    title: "FMath::MapRangeClamped",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Linear Interpolation","Normalization","Range Remapping"],
    summary: "This is arguably the most useful math function in Unreal. it takes a value from one range and \"stretches\" it to fit into another range.",
    codeSnippet: `// Turn 'Current Speed' into 'Engine Pitch'
...
float EnginePitch = FMath::MapRangeClamped(
    ...
    explanation: `<h3>Value Mapping</h3>
  ...
  {
    id: "lego-113",
    slug: "attachtocomponent",
    title: "AttachToComponent",
    type: 'lego-piece',
    pieceType: "Components & Hierarchy",
    tags: ["Components","Dynamic Hierarchy","Sockets","Attachment Rules"],
    summary: "Unlike SetupAttachment, which is for constructors, AttachToComponent is used during active gameplay to glue actors or components together.",
    codeSnippet: `// Picking up a weapon at runtime
...
MyWeapon->AttachToComponent(GetMesh(), Rules, TEXT("Hand_R_Socket"));`,
    explanation: `<h3>Runtime Parenting</h3>
  ...
  {
    id: "lego-114",
    slug: "fcollisionqueryparams",
    title: "FCollisionQueryParams",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Query Optimization","Physics Filtering","Collision Resolution"],
    summary: "When you perform a Trace or a Sweep, the FCollisionQueryParams struct tells the engine exactly how to behave and what to ignore.",
    codeSnippet: `FCollisionQueryParams Params;
...
Params.bReturnPhysicalMaterial = true;`,
    explanation: `<h3>Filtering Physics Queries</h3>
  ...
  {
    id: "lego-201",
    slug: "uaniminstance-c-base",
    title: "UAnimInstance C++ Base",
    type: 'lego-piece',
    pieceType: "Animation",
    tags: ["Animation","AnimInstance Lifecycle","Data-Driven Animation","Performance Optimization"],
    summary: "While the AnimGraph is great for visual blending, the logic that drives those transitions (calculating speed, falling state, combat mode) should live in a C++ base class for performance and organizati",
    codeSnippet: `// --- MyAnimInstance.h ---
UCLASS()
...
void UMyAnimInstance::NativeUpdateAnimation(float DeltaSeconds) {
    ...
    explanation: `<h3>Driving Animation with C++</h3>
  ...
  {
    id: "lego-202",
    slug: "montageplay-delegates",
    title: "Montage_Play & Delegates",
    type: 'lego-piece',
    pieceType: "Animation",
    tags: ["Animation","Animation Montages","Dynamic Delegates","State Synchronization"],
    summary: "Montages allow you to play specific animations (like an attack or a reload) on top of your character's state machine. Using Delegates allows your gameplay code to know exactly when the animation finis",
    codeSnippet: `// Triggering an attack montage and reacting to its end
...
void AMyCharacter::OnAttackFinished(UAnimMontage* Montage, bool bInterrupted) {
    ...
    explanation: `<h3>Orchestrating Actions</h3>
  ...
  {
    id: "lego-203",
    slug: "uaiperceptioncomponent",
    title: "UAIPerceptionComponent",
    type: 'lego-piece',
    pieceType: "AI & Nav",
    tags: ["AI","AI Senses","Stimulus Handling","NPC Awareness"],
    summary: "The AIPerception system is the modern way NPCs \"see\" and \"hear\" the world. It is much more efficient than doing manual line traces from the AI's eyes every frame.",
    codeSnippet: `// --- MyAIController.h ---
...
AMyAIController::AMyAIController() {
  ...
  {
    id: "lego-204",
    slug: "ubttasknode-custom-task",
    title: "UBTTaskNode (Custom Task)",
    type: 'lego-piece',
    pieceType: "AI & Nav",
    tags: ["AI","Behavior Trees","Blackboard Integration","Navigation Queries"],
    summary: "While Behavior Trees are usually edited visually, the actual logic for complex tasks (like finding a tactical position or pathfinding) is best written in C++ for speed and reusability.",
    codeSnippet: `// --- BTTask_FindLocation.h ---
UCLASS()
...
EBTNodeResult::Type UBTTask_FindLocation::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) {
    ...
    explanation: `<h3>Behavior Tree Extensions</h3>
  ...
  {
    id: "lego-210",
    slug: "asc-initialization-gas",
    title: "ASC Initialization (GAS)",
    type: 'lego-piece',
    pieceType: "Ability System",
    tags: ["Ability","Ability System Component","Owner vs Avatar","GAS Lifecycle"],
    summary: "The Ability System Component (ASC) is the brain of the Gameplay Ability System. Before you can use any abilities or attributes, you must initialize the AbilityActorInfo.",
    codeSnippet: `// --- MyCharacter.cpp ---
...
void AMyCharacter::OnRep_PlayerState() {
    ...
    explanation: `<h3>The GAS Foundation</h3>
  ...
  {
    id: "lego-211",
    slug: "uattributeset-definition",
    title: "UAttributeSet Definition",
    type: 'lego-piece',
    pieceType: "Ability System",
    tags: ["Ability","Gameplay Attributes","Data Clamping","Stat Management"],
    summary: "AttributeSets are where you define the numerical values of your character, such as Health, Mana, or Strength. GAS handles the complex math of \"Base Value\" vs \"Current Value\" (after buffs/debuffs) auto",
    codeSnippet: `// Use the standard ACCESSORS macro for GAS
...
public:
    ...
    explanation: `<h3>Defining Actor Stats</h3>
  ...
  {
    id: "lego-212",
    slug: "ugameinstancesubsystem",
    title: "UGameInstanceSubsystem",
    type: 'lego-piece',
    pieceType: "Subsystems",
    tags: ["Subsystems","Persistence","Modular Managers","Engine Lifecycles"],
    summary: "UGameInstanceSubsystem is the gold standard for global managers that need to exist from the moment the game starts until it closes. They automatically survive level transitions.",
    codeSnippet: `// --- SaveSubsystem.h ---
UCLASS()
...
SaveSys->PlayerInventory.Add("HealthPotion", 5);`,
    explanation: `<h3>Global Persistent Logic</h3>
  ...
  {
    id: "lego-213",
    slug: "uworldsubsystem",
    title: "UWorldSubsystem",
    type: 'lego-piece',
    pieceType: "Subsystems",
    tags: ["Subsystems","Level Lifecycle","World Context","Automatic Instantiation"],
    summary: "Unlike GameInstance subsystems, a UWorldSubsystem is tied to the lifecycle of a single level (World). When you change levels, the old subsystem is destroyed and a new one is created for the next world",
    codeSnippet: `// --- ScoreSubsystem.h ---
UCLASS()
...
Score->AddScore(100);`,
    explanation: `<h3>Level-Specific Managers</h3>
  ...
  {
    id: "lego-220",
    slug: "enhanced-input-binding",
    title: "Enhanced Input Binding",
    type: 'lego-piece',
    pieceType: "Enhanced Input",
    tags: ["Enhanced","Input Binding","Action Values","Unified Input"],
    summary: "Enhanced Input replaces the old BindAction and BindAxis with a unified system. It uses FInputActionValue to handle everything from simple booleans (buttons) to 2D vectors (thumbsticks).",
    codeSnippet: `// --- MyCharacter.h ---
UPROPERTY(EditAnywhere, Category="Input")
...
void AMyCharacter::Move(const FInputActionValue& Value) {
    ...
    explanation: `<h3>Binding Actions in UE5</h3>
  ...
  {
    id: "lego-221",
    slug: "tsoftobjectptr-lazy-loading",
    title: "TSoftObjectPtr (Lazy Loading)",
    type: 'lego-piece',
    pieceType: "Asset Management",
    tags: ["Asset","Memory Footprint","Lazy Loading","Asset Paths"],
    summary: "Usually, when you use a raw pointer (UStaticMesh*), Unreal loads that asset into memory the moment the actor exists. This is called \"Hard Loading\" and can lead to massive RAM usage if you have many va",
    codeSnippet: `// --- MyActor.h ---
...
void AMyActor::LoadAsset() {
    ...
    explanation: `<h3>Smart Memory Management</h3>
  ...
  {
    id: "lego-222",
    slug: "uaudiocomponent-management",
    title: "UAudioComponent Management",
    type: 'lego-piece',
    pieceType: "Audio",
    tags: ["Audio","Continuous Audio","Metasound Parameters","Audio Control"],
    summary: "While PlaySoundAtLocation is good for one-off explosions, use UAudioComponent when you need to control a sound over time (like an engine idling or a looping ambient wind).",
    codeSnippet: `// --- MyActor.cpp ---
AMyActor::AMyActor() {
...
void AMyActor::PlayEngineSound(float RPM) {
    ...
    explanation: `<h3>Dynamic Soundscapes</h3>
  ...
  {
    id: "lego-230",
    slug: "metamakeeditwidget",
    title: "meta=(MakeEditWidget)",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Editor Experience","Relative Offsets","Viewport Widgets"],
    summary: "When you have an FVector that represents a relative position (like a patrol point or a particle offset), it's hard to guess the coordinates. MakeEditWidget adds a clickable diamond icon in the editor ",
    codeSnippet: `// .h
...
FVector WorldTarget = GetTransform().TransformPosition(TargetLocation);`,
    explanation: `<h3>Visualizing Relative Offsets</h3>
  ...
  {
    id: "lego-231",
    slug: "witheditor-editor-only-code",
    title: "WITH_EDITOR (Editor-Only Code)",
    type: 'lego-piece',
    pieceType: "Macros & Reflection",
    tags: ["Macros","Pre-processor Macros","Build Configurations","Optimization"],
    summary: "A lot of the code you write (debug drawings, editor UI, property validation) is only needed while you are making the game. WITH_EDITOR ensures that this code is completely removed from the final \"Ship",
    codeSnippet: `#if WITH_EDITOR
...
void AMyActor::SomeLogic() {
    ...
    explanation: `<h3>Stripping Development Bloat</h3>
  ...
  {
    id: "lego-232",
    slug: "onconstruction-c-script",
    title: "OnConstruction (C++ Script)",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Construction Script","Procedural Generation","Editor Feedback"],
    summary: "OnConstruction is the C++ equivalent of the Construction Script in Blueprints. It runs whenever you move the actor or change a property in the editor, providing instant visual feedback.",
    codeSnippet: `// --- MyActor.cpp ---
void AMyActor::OnConstruction(const FTransform& Transform) {
    ...
    explanation: `<h3>Live Editor Updates</h3>
  ...
  {
    id: "lego-233",
    slug: "postinitializecomponents",
    title: "PostInitializeComponents",
    type: 'lego-piece',
    pieceType: "Lifecycle & World",
    tags: ["Lifecycle","Initialization Order","Component Communication","Lifecycle Synchronization"],
    summary: "When you create components in the Constructor, they aren't \"ready\" yet. PostInitializeComponents is the lifecycle hook that fires after every component on the actor has been fully initialized but befo",
    codeSnippet: `// --- MyActor.cpp ---
void AMyActor::PostInitializeComponents() {
    ...
    explanation: `<h3>Cross-Component Wiring</h3>
  ...
  {
    id: "lego-234",
    slug: "overlapmultibychannel",
    title: "OverlapMultiByChannel",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","AoE Logic","Physics Queries","Collision Channels"],
    summary: "Unlike a Line Trace which only finds what's directly in front of you, OverlapMultiByChannel finds every actor within a specific shape (Sphere, Box, or Capsule).",
    codeSnippet: `TArray<FOverlapResult> Overlaps;
...
for (const FOverlapResult& Result : Overlaps) {
    ...
    explanation: `<h3>Area of Effect Detection</h3>
  ...
  {
    id: "lego-235",
    slug: "widgetcomponent-3d-ui",
    title: "WidgetComponent (3D UI)",
    type: 'lego-piece',
    pieceType: "UI & Debug",
    tags: ["UI","UMG in 3D","Space Transformations","Billboarding"],
    summary: "The WidgetComponent is how you attach 2D UMG widgets to 3D actors in the world. This is most commonly used for floating health bars, nameplates, or interactive computer screens.",
    codeSnippet: `// --- MyCharacter.cpp ---
AMyCharacter::AMyCharacter() {
    ...
    explanation: `<h3>Floating Head-Up Displays</h3>
  ...
  {
    id: "lego-236",
    slug: "tset-unique-collections",
    title: "TSet (Unique Collections)",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Hash Tables","O(1) Complexity","Uniqueness Enforcement"],
    summary: "While TArray is the most common container, TSet is superior when you need to ensure every item is unique and you need to search for items extremely fast.",
    codeSnippet: `TSet<AActor*> EncounteredEnemies;
...
void AMyChar::OnSeeEnemy(AActor* Enemy) {
    ...
    explanation: `<h3>Speed and Uniqueness</h3>
  ...
  {
    id: "lego-237",
    slug: "tobjectptr-modern-pointers",
    title: "TObjectPtr (Modern Pointers)",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Pointer Wrapping","Memory Tracking","UE5 Coding Standards"],
    summary: "In Unreal Engine 5, TObjectPtr has replaced raw pointers (UObject*) for class properties. While they behave like raw pointers in most cases, they allow the engine to perform \"Lazy Loading\" and better ",
    codeSnippet: `// --- Modern UE5 Header ---
...
void AMyActor::BeginPlay() {
    ...
    explanation: `<h3>The UE5 Standard</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Animation",
    tags: ["Animation","Animation Events","Visual/Gameplay Sync","Performance"],
    summary: "AnimNotifies are markers placed in an animation that trigger code at a specific frame. While you can create them in Blueprints, writing them in C++ is more performant and allows for complex logic shar",
    codeSnippet: `// --- MyAnimNotify.h ---
UCLASS()
...
void UMyAnimNotify::Notify(USkeletalMeshComponent* MeshComp, ...) {
    ...
    explanation: `<h3>Frame-Perfect Triggers</h3>
  ...
  {
    id: "lego-241",
    slug: "uanimnotifystate-windows",
    title: "UAnimNotifyState (Windows)",
    type: 'lego-piece',
    pieceType: "Animation",
    tags: ["Animation","Duration Notifies","Melee Logic","Component Activation"],
    summary: "Unlike a standard Notify which fires once, UAnimNotifyState defines a Duration (a window of time). It has three hooks: Begin, Tick, and End.",
    codeSnippet: `// --- MyNotifyState.cpp ---
...
void UMyNotifyState::NotifyEnd(USkeletalMeshComponent* MeshComp, ...) {
    ...
    explanation: `<h3>State Windows</h3>
  ...
  {
    id: "lego-242",
    slug: "unavigationsystemv1",
    title: "UNavigationSystemV1",
    type: 'lego-piece',
    pieceType: "AI & Nav",
    tags: ["AI","Pathfinding","NavMesh Queries","Spatial Reasoning"],
    summary: "In UE5, AI doesn't just \"move\" to a location; it needs to know if that location is reachable on the NavMesh. The UNavigationSystemV1 is the gateway to these queries.",
    codeSnippet: `UNavigationSystemV1* NavSys = FNavigationSystem::GetCurrent<UNavigationSystemV1>(GetWorld());
...
if (NavSys) {
    ...
    explanation: `<h3>Navigating the World</h3>
  ...
  {
    id: "lego-243",
    slug: "ugameplayability-c",
    title: "UGameplayAbility (C++)",
    type: 'lego-piece',
    pieceType: "Ability System",
    tags: ["Ability","Ability Lifecycle","Cost & Cooldown","GAS Architecture"],
    summary: "A UGameplayAbility is a self-contained unit of logic, like \"Fireball\", \"Jump\", or \"Heavy Attack\". It manages its own lifecycle, cooldowns, and costs (Mana/Stamina).",
    codeSnippet: `// --- MyAbility.cpp ---
void UMyAbility::ActivateAbility(...) {
    ...
    explanation: `<h3>C++ Ability Logic</h3>
  ...
  {
    id: "lego-250",
    slug: "imc-management-input",
    title: "IMC Management (Input)",
    type: 'lego-piece',
    pieceType: "Enhanced Input",
    tags: ["Enhanced","Input Contexts","Dynamic Remapping","Priority Layers"],
    summary: "One of the biggest advantages of Enhanced Input is the ability to swap Input Mapping Contexts (IMC) at runtime. You can have a \"Base\" context for walking and a \"UI\" context for menus.",
    codeSnippet: `// --- MyCharacter.cpp ---
void AMyCharacter::PawnClientRestart() {
    ...
    explanation: `<h3>Dynamic Input Contexts</h3>
  ...
  {
    id: "lego-251",
    slug: "fstreamablemanager-async",
    title: "FStreamableManager (Async)",
    type: 'lego-piece',
    pieceType: "Asset Management",
    tags: ["Asset","Asynchronous I/O","Thread Safety","Hitch Prevention"],
    summary: "If you use LoadSynchronous, the game will \"hitch\" or freeze for a few milliseconds while the file is read from the disk. FStreamableManager allows you to load assets in the background without affectin",
    codeSnippet: `// --- MyActor.cpp ---
...
void AMyActor::OnLoadComplete() {
    ...
    explanation: `<h3>Smooth Asset Loading</h3>
  ...
  {
    id: "lego-252",
    slug: "playsoundatlocation",
    title: "PlaySoundAtLocation",
    type: 'lego-piece',
    pieceType: "Audio",
    tags: ["Audio","Spatial Audio","Attenuation","One-shot Effects"],
    summary: "For sounds that don't need to be tracked or stopped (like a footstep, a gunshot, or an explosion), PlaySoundAtLocation is the most efficient choice. It spawns the sound and cleans itself up automatica",
    codeSnippet: `// One-shot spatialized audio
UGameplayStatics::PlaySoundAtLocation(
    ...
    explanation: `<h3>Fire-and-Forget Audio</h3>
  ...
  {
    id: "lego-253",
    slug: "fquat-quaternions",
    title: "FQuat (Quaternions)",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Mathematical Stability","Gimbal Lock Prevention","SLERP"],
    summary: "While FRotator (Pitch/Yaw/Roll) is easy to understand, it fails when you look straight up or down—this is called Gimbal Lock. Quaternions (FQuat) use 4D math to represent rotation, which is perfectly ",
    codeSnippet: `// Slerp (Spherical Linear Interpolation) between rotations
...
SetActorRotation(SmoothQuat);`,
    explanation: `<h3>Gimbal-Free Rotation</h3>
                    <p>While <code>FRotator</code> (Pitch/Yaw/Roll) is easy to understand, it fails when you look straight up or down—this is called <strong>Gimbal Lock</strong>. Quaternions (<code>FQuat</code>) use 4D math to represent rotation, which is perfectly stable at any angle.</p>
    ...
    diagram: `flowchart TD
                    Rot[FRotator] --"Limits"--> Gimbal[Gimbal Lock at 90°]
                    Quat[FQuat] --"Stability"--> Smooth[Perfect 360° Movement]`,
  ...
  {
    id: "lego-260",
    slug: "single-cast-delegates",
    title: "Single-Cast Delegates",
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Return Values","Tight Coupling","Callback Patterns"],
    summary: "Unlike Multicast delegates which \"Broadcast\" to everyone, a Single-cast delegate is a private line between two objects. Its biggest advantage is that it can **Return a Value**.",
    codeSnippet: `// .h - Declaration
...
if (CanInteractDelegate.IsBound()) {
    ...
    explanation: `<h3>One-to-One Communication</h3>
  ...
  {
    id: "lego-261",
    slug: "agamemodebase-rules",
    title: "AGameModeBase (Rules)",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Match Lifecycle","Class Defaults","Actor Spawning"],
    summary: "The GameMode is the absolute authority of your game level. It defines the rules, decides who wins or loses, and handles the spawning of players.",
    codeSnippet: `// --- MyGameMode.cpp ---
...
void AMyGameMode::PostLogin(APlayerController* NewPlayer) {
    ...
    explanation: `<h3>The Game's Referee</h3>
  ...
  {
    id: "lego-262",
    slug: "aplayerstate-persistence",
    title: "APlayerState (Persistence)",
    type: 'lego-piece',
    pieceType: "Framework & Logic",
    tags: ["Framework","Data Persistence","Player Identity","Session Stats"],
    summary: "While the Pawn is just a physical \"Puppet\" that can be killed and replaced, the PlayerState is the \"Soul\" of the player. It holds all the data that should survive even if the character dies.",
    codeSnippet: `// --- MyPlayerState.h ---
UCLASS()
...
public:
    ...
    explanation: `<h3>The Player's Identity</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Key-Value Association","Fast Lookup","Data Mapping"],
    summary: "TMap allows you to associate a Key (like a Name or an ID) with a Value (like an Actor pointer or a Struct). It is perfect for inventories, stat sheets, or settings.",
    codeSnippet: `// An inventory mapping Item Names to Quantity
...
Inventory.Remove(TEXT("OldKey"));`,
    explanation: `<h3>The Dictionary Container</h3>
  ...
  {
    id: "lego-270",
    slug: "fgameplaytagcontainer",
    title: "FGameplayTagContainer",
    type: 'lego-piece',
    pieceType: "Ability System",
    tags: ["Ability","Labeling Systems","Hierarchical Logic","Data-Driven Tags"],
    summary: "Gameplay Tags are strings that act like \"Labels\" for actors or states. Unlike Enums which can only have one value, a FGameplayTagContainer can hold many tags at once.",
    codeSnippet: `FGameplayTagContainer MyTags;
...
if (MyTags.HasTag(FGameplayTag::RequestGameplayTag(TEXT("Status")))) {
    ...
    explanation: `<h3>Hierarchical Labeling</h3>
  ...
  {
    id: "lego-271",
    slug: "input-modifiers-curves",
    title: "Input Modifiers (Curves)",
    type: 'lego-piece',
    pieceType: "Enhanced Input",
    tags: ["Enhanced","Data Transformation","Player Comfort","Signal Processing"],
    summary: "Input Modifiers allow you to change the \"Raw\" data from a controller before it reaches your gameplay logic. This is perfect for handling \"Dead-zones\" (drifting sticks) or \"Sensitivity Curves\".",
    codeSnippet: `// Adding a modifier via C++ (rare, usually in BP asset)
...
MyAction->Modifiers.Add(Deadzone);`,
    explanation: `<h3>Sanitizing Player Input</h3>
  ...
  },
  {
    ...
    type: 'lego-piece',
    pieceType: "Asset Management",
    tags: ["Asset","Data-Driven Design","Asset Tracking","Configuration"],
    summary: "UPrimaryDataAsset is the best way to store \"Buckets\" of data that designers can edit. Instead of hard-coding values for 50 different swords, you create 50 Data Assets.",
    codeSnippet: `// --- WeaponData.h ---
UCLASS()
...
public:
    ...
    explanation: `<h3>The Designer's Toolbox</h3>
  ...
  {
    id: "lego-273",
    slug: "metasounds-c-interface",
    title: "Metasounds C++ Interface",
    type: 'lego-piece',
    pieceType: "Audio",
    tags: ["Audio","Procedural Audio","Real-time Modulation","Sound Synthesis"],
    summary: "Metasounds are the new procedural audio graphs in UE5. Unlike old Sound Cues, they are fully programmable and can react to data in real-time.",
    codeSnippet: `// Modulating a sound based on health
UAudioComponent* AC = ...;
...
AC->SetTriggerParameter(TEXT("OnTakeDamage"));`,
    explanation: `<h3>Procedural Audio Control</h3>
                    ...
                    <p>You can send any data (Floats, Booleans, Triggers) from your C++ logic into the Metasound. This allows the audio to "Evolve" as the game state changes—for example, making the music more intense as the player's health drops.</p>`,
    diagram: `flowchart LR
  ...
  {
    id: "lego-274",
    slug: "sweepsinglebychannel",
    title: "SweepSingleByChannel",
    type: 'lego-piece',
    pieceType: "Physics & Collision",
    tags: ["Physics","Physical Volume","Collision Geometry","Intersection Tests"],
    summary: "While a Line Trace is a single \"Infinitely Thin\" beam, a Sweep moves a physical 3D shape (like a box or sphere) through space to see if it hits anything.",
    codeSnippet: `FHitResult Hit;
FVector Start = GetActorLocation();
...
bool bHit = GetWorld()->SweepSingleByChannel(
    ...
    explanation: `<h3>Volumetric Collision</h3>
  ...
  {
    id: "lego-275",
    slug: "ukismetmathlibraryvinterpto",
    title: "UKismetMathLibrary::VInterpTo",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Motion Smoothing","Vector Math","Juice"],
    summary: "VInterpTo is the vector version of interpolation. It calculates a smooth path between two 3D points over several frames.",
    codeSnippet: `// Inside Tick
...
SetActorLocation(NewPos);`,
    explanation: `<h3>Smoothing Position Changes</h3>
                    ...
                    <h4>Ease-In/Out</h4>
                    <p>The standard <code>VInterpTo</code> uses an exponential curve—it moves fast at the start and slows down as it reaches the target. For a constant, linear speed, use <code>VInterpTo_Constant</code> instead.</p>`,
    diagram: `flowchart LR
  ...
  {
    id: "lego-280",
    slug: "ubtservice-ai-logic",
    title: "UBTService (AI Logic)",
    type: 'lego-piece',
    pieceType: "AI & Nav",
    tags: ["AI","Optimization","Blackboard Updates","BT Infrastructure"],
    summary: "A UBTService is logic that runs at a set interval (e.g., every 0.5 seconds) as long as its branch of the Behavior Tree is active. This is much more efficient than checking conditions every single fram",
    codeSnippet: `// --- BTService_CheckDistance.h ---
UCLASS()
...
void UBTService_CheckDistance::TickNode(UBehaviorTreeComponent& OwnerComp, ...) {
    ...
    explanation: `<h3>Recurring AI Checks</h3>
  ...
  {
    id: "lego-281",
    slug: "fgameplayeffectcontexthandle",
    title: "FGameplayEffectContextHandle",
    type: 'lego-piece',
    pieceType: "Ability System",
    tags: ["Ability","Metadata Passing","Hit Attribution","GAS Context"],
    summary: "When you apply a Gameplay Effect (like damage), you often need the receiver to know Where they were hit (for blood splatters) or Who hit them (for kill credit). FGameplayEffectContextHandle is the sui",
    codeSnippet: `// Passing hit data through GAS
...
ASC->ApplyGameplayEffectSpecToTarget(*Spec.Data.Get(), TargetASC);`,
    explanation: `<h3>Carrying Hit Data</h3>
  ...
  {
    id: "lego-282",
    slug: "ulocalplayersubsystem",
    title: "ULocalPlayerSubsystem",
    type: 'lego-piece',
    pieceType: "Subsystems",
    tags: ["Subsystems","Personalization","Input Settings","Local Context"],
    summary: "While GameInstance is global for the whole application, ULocalPlayerSubsystem is unique to each person playing. In a single-player game, there's only one, but it's the best place for player-specific s",
    codeSnippet: `// --- UIPreferenceSubsystem.h ---
UCLASS()
...
UUIPreferenceSubsystem* Prefs = ULocalPlayer::GetSubsystem<UUIPreferenceSubsystem>(GetLocalPlayer());`,
    explanation: `<h3>Per-Player Logic</h3>
  ...
  {
    id: "lego-283",
    slug: "tsoftclassptr-bp-loading",
    title: "TSoftClassPtr (BP Loading)",
    type: 'lego-piece',
    pieceType: "Asset Management",
    tags: ["Asset","Class Referencing","Memory Optimization","BP Performance"],
    summary: "If you use TSubclassOf&lt;AMyActor&gt;, the engine will force-load that Blueprint into memory as soon as the spawner exists. If that Blueprint is large, your game will lag. TSoftClassPtr prevents this",
    codeSnippet: `// --- Spawner.h ---
...
void ASpawner::Spawn() {
    ...
    explanation: `<h3>Referencing Blueprints Safely</h3>
  ...
  {
    id: "lego-284",
    slug: "fbox-fsphere-bounds",
    title: "FBox & FSphere Bounds",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Bounding Volumes","Proximity Checks","Geometry Math"],
    summary: "Sometimes you don't need a full collision component. FBox and FSphere are lightweight mathematical shapes used to check if points or other shapes are overlapping.",
    codeSnippet: `// Check if a point is within a trigger sphere
...
if (DamageArea.IsInside(EnemyLoc)) {
    ...
    explanation: `<h3>Primitive Containment</h3>
  ...
  {
    id: "lego-285",
    slug: "tfunctionref-efficiency",
    title: "TFunctionRef (Efficiency)",
    type: 'lego-piece',
    pieceType: "Delegates & Events",
    tags: ["Delegates","Lambda Optimization","Stack vs Heap","Functional C++"],
    summary: "When you want to pass a Lambda into a function, TFunctionRef is the fastest way to do it. Unlike TFunction, it does not allocate memory on the heap.",
    codeSnippet: `// Function that takes a lambda as an argument
...
ProcessActors([](AActor* A){ 
    ...
    explanation: `<h3>High-Performance Callbacks</h3>
                    ...
                    <h4>The Catch</h4>
                    <p>Because it doesn't allocate memory, it is "Transient". You can only use it inside the function it was passed to. Never store a <code>TFunctionRef</code> as a class variable—it will point to invalid memory once the function ends!</p>`,
    diagram: `flowchart LR
  ...
  {
    id: "lego-286",
    slug: "static-mechanics",
    title: "Static Mechanics",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Class Scope","Global Helpers","Memory Sharing"],
    summary: "The static keyword in C++ means a variable or function belongs to the Class itself, rather than a specific instance. All 500 instances of AMyActor will share the exact same static variable.",
    codeSnippet: `// .h
class AMyActor : public AActor {
...
AMyActor::AMyActor() {
    ...
    explanation: `<h3>Shared Global State</h3>
  ...
  {
    id: "lego-120",
    slug: "tarrayfilterbypredicate",
    title: "TArray::FilterByPredicate",
    type: 'lego-piece',
    pieceType: "Data & Containers",
    tags: ["Data","Functional Programming","Collection Manipulation","Lambdas"],
    summary: "Instead of writing a long for-loop to find specific items in a list, FilterByPredicate allows you to do it in one line using a Lambda.",
    codeSnippet: `TArray<AActor*> AllEnemies;
// ... populate array ...
...
TArray<AActor*> WeakEnemies = AllEnemies.FilterByPredicate([](const AActor* Enemy){
    ...
    explanation: `<h3>Smart List Filtering</h3>
  ...
  {
    id: "lego-121",
    slug: "ftransforminversetransformposition",
    title: "FTransform::InverseTransformPosition",
    type: 'lego-piece',
    pieceType: "Math & Space",
    tags: ["Math","Coordinate Systems","Relative Transformation","Vector Basis"],
    summary: "This function takes a point in the world and tells you where it is from the \"Perspective\" of an actor.",
    codeSnippet: `// Where is this explosion relative to the player?
...
if (RelativeLoc.Y < 0) {
    ...
    explanation: `<h3>World to Local Conversion</h3>
  ...
  {
    id: "lego-122",
    slug: "forward-declarations",
    title: "Forward Declarations",
    type: 'lego-piece',
    pieceType: "C++ Mechanics",
    tags: ["C++","Compilation Performance","Dependency Management","C++ Linking"],
    summary: "In C++, whenever you #include a file, the compiler has to copy-paste the entire contents of that file. In large projects, this can lead to massive compile times.",
    codeSnippet: `// --- MyActor.h ---
#pragma once
...
class AMyActor : public AActor {
    ...
    explanation: `<h3>Optimization for Build Times</h3>
