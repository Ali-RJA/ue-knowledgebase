...
import { Grid2 as Grid, useParams, Link as RouterLink } from 'react-router-dom';@
...
import { Grid2 as Grid, HtmlContent } from '../components/content/HtmlContent';@
...
@
      <Grid2 container spacing={4}>@
        <Grid2 xs={12} lg={relatedItems.length > 0 ? 8 : 12}>@
          <Box sx={{ mb: 3 }}>@
